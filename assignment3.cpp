...
void QuadraticSolutions(double, double, double);  
...
cout << "================= Maximum() ===================" << endl;  
cout << "If we try 2.5, 7.5 and 5.75 the function return:" << Maximum(2.5,7.5,5.75)<< endl;  
cout << "If we try 7.5, 7.5 and 5.75 the function return:" << Maximum(7.5,7.5,5.75)<< endl;  
cout << "If we try 7.5, 7.5 and 7.75 the function return:" << Maximum(7.5,7.5,7.75)<< endl;  
cout << "================= EvenOdd() ===================" << endl;  
...
QuadraticSolutions(3.2,3.5,2.2); // NOT DONE YET  
cout << " !@#$%^&*^&%$#%^^%$#%^&***(#$#$%%^(*^%##@#%^&**^%$%&&)%" << endl;  
...
void QuadraticSolutions(double a, double b, double c)  
{  
return;  
}  
